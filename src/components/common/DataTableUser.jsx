...
const DataTableUser = ({data,currentPage,numOfPage,onPageChange,onChangeItemsPerPage,onSearchString,handleDelete, onClickCheckBox, onSelectAll, selected}) => {
                            ...
                            return (
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        ...
                                        <Link className='btn btn-warning' to={`/user/edit/${item.id}`}>EDIT</Link>
                                    </td>
                                </tr>
                            )
                        })}
